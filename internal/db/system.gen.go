...
func newSystem(db *gorm.DB, opts ...gen.DOOption) system {
	...
	_system.ApplianceID = field.NewInt32(tableName, "appliance_id")
	_system.Name = field.NewString(tableName, "name")
	_system.UID = field.NewString(tableName, "uid")
	_system.Sid = field.NewString(tableName, "sid")
...
func (s *system) updateTableName(table string) *system {
	...
	s.ApplianceID = field.NewInt32(table, "appliance_id")
...
func (s *system) fillFieldMap() {
	...
	s.fieldMap["id"] = s.ID
	s.fieldMap["appliance_id"] = s.ApplianceID
...
func (s systemDo) GetByID(id int) (result model.System, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, id)
	generateSQL.WriteString("SELECT * FROM system WHERE id=? ")
...
func (s systemDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) ISystemDo {
